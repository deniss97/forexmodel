...
На LKOH преимущество модели (+0.05% на сделку до издержек) втрое меньше комиссии,
и каскад фильтров сжимает выборку до 4–6 сделок. На серебре, где комиссия
составляет 2.3% целевого движения вместо 26.7%, получается 152 сделки за год с
profit factor 1.28 — но результат держится на одном значении порога мета-модели,
и доверять ему пока нельзя. Разбор и что делать дальше — там же.
