...
**Результаты последнего прогона и план дальнейших шагов — в [RESULTS.md](RESULTS.md).**
Короткий вывод: пайплайн работает от начала до конца, но преимущество модели
(+0.05% на сделку до издержек) втрое меньше комиссии (0.15% за круг), и каскад
фильтров сжимает выборку до 4–6 сделок. Что с этим делать — там же.
